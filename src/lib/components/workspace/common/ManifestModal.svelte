			...
			<div class=" flex flex-col w-full sm:flex-row sm:justify-center sm:space-x-6">
				...
				>
					<div class="px-1 text-sm">
						...
						<div class="my-2">
							{$i18n.t(
								'Your entire contribution will go directly to the plugin developer; Friday does not take any percentage. However, the chosen funding platform might have its own fees.'
							)}
						</div>
