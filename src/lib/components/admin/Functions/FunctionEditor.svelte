...
funding_url: https://github.com/YOUR_USERNAME
version: 0.1
"""
		...
		>
			<div class="flex flex-col flex-1 overflow-auto h-0 rounded-lg">
				...
				<div class="mb-2 flex-1 overflow-auto h-0 rounded-lg">
					<!-- Removed CodeEditor functionality -->
					<textarea
						bind:value={content}
						class="w-full h-full p-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg font-mono text-sm"
						on:input={(e) => {
