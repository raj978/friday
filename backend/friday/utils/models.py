...
from friday.routers import openai, ollama
...
from friday.env import BYPASS_MODEL_ACCESS_CONTROL, SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL
...
async def get_all_base_models(request: Request, user: UserModel = None):
    ...
    # Functions removed in Friday rebrand - no function models
...
async def get_all_models(request, refresh: bool = False, user: UserModel = None):
    ...
    # Functions removed in Friday rebrand - no action/filter IDs
    # global_action_ids = [
    ...
    # Functions removed in Friday rebrand - function module loading disabled
    # def get_function_module_by_id(function_id):
    #     function_module, _, _ = get_function_module_from_cache(request, function_id)
    #     return function_module

    # Functions removed in Friday rebrand - action/filter processing disabled
    # for model in models:
    #     action_ids = [
    #         action_id
    ...
    # Set empty actions and filters for all models (Functions removed in Friday rebrand)
    for model in models:
