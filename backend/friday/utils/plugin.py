...
from friday.env import SRC_LOG_LEVELS, PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
# Functions model removed in Friday rebrand
# from open_webui.models.functions import Functions
from friday.models.tools import Tools
...
# Functions removed in Friday rebrand - function loading disabled
def load_function_module_by_id(function_id: str, content: str | None = None):
    """Function loading disabled - Functions model removed"""
    raise Exception("Function loading is disabled in Friday")
...
# Functions removed in Friday rebrand - function caching disabled
def get_function_module_from_cache(request, function_id, load_from_db=True):
    """Function caching disabled - Functions model removed"""
    raise Exception("Function caching is disabled in Friday")
...
def install_tool_and_function_dependencies():
    ...
    Functions removed in Friday rebrand - only processing tools now.
    ...
    all_dependencies = ""
    try:
        # Functions removed in Friday rebrand - commented out function processing
