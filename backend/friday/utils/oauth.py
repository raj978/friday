...
from friday.models.auths import Auths
from friday.models.oauth_sessions import OAuthSessions
from friday.models.users import Users


from friday.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from friday.utils.misc import parse_duration
from friday.utils.auth import get_password_hash, create_token
...
from friday.env import SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in Friday: {[g.name for g in all_available_groups]}"
        )
