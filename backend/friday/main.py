...
from friday.utils import logger
from friday.utils.audit import AuditLevel, AuditLoggingMiddleware
from friday.utils.logger import start_logger
...
from friday.routers import (
    ...
    configs,
    files,
    # functions,  # Functions removed in Friday rebrand
    memories,
    models,
    knowledge,
    prompts,
...
from friday.internal.db import Session, engine
...
from friday.config import (
    ...
    # Code Execution/Interpreter removed in Friday rebrand
...
from friday.utils.models import (
    get_all_models,
    get_all_base_models,
    check_model_access,
    get_filtered_models,
)
from friday.utils.chat import (
    generate_chat_completion as chat_completion_handler,
    chat_completed as chat_completed_handler,
    chat_action as chat_action_handler,
)
from friday.utils.embeddings import generate_embeddings
from friday.utils.middleware import process_chat_payload, process_chat_response
from friday.utils.access_control import has_access

from friday.utils.auth import (
    get_license_data,
...
from friday.utils.plugin import install_tool_and_function_dependencies
from friday.utils.oauth import (
...
from friday.utils.security_headers import SecurityHeadersMiddleware
from friday.utils.redis import get_redis_connection

from friday.tasks import (
...
from friday.utils.redis import get_sentinels_from_env
...
print(
    ...
    "Good morning. I am Friday. I'm here to help you."

    v{VERSION} - Your Personal AI Assistant.
...
if ENABLE_OTEL:
    from friday.utils.telemetry.setup import setup as setup_opentelemetry
...
app.state.config.RAG_SEARCH_ALL_BY_DEFAULT = RAG_SEARCH_ALL_BY_DEFAULT
        ...
        if request.method == "GET":
            ...
            if "shared" in query_params and len(query_params["shared"]) > 0:
                ...
                if text:
                    ...
                    if urls:
                        from friday.retrieval.loaders.youtube import _parse_video_id
        ...
        **(
            {
                ...
                # Code execution removed in Friday rebrand
                # "code": {
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for Friday.
