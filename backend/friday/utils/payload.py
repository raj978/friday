from friday.utils.task import prompt_template, prompt_variables_template
...
def remove_open_webui_params(params: dict) -> dict:
    """
    Removes Friday specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with Friday parameters removed.
    """
    open_webui_params = {
...
def apply_model_params_to_body_ollama(params: dict, form_data: dict) -> dict:
    ...
    def parse_json(value: str) -> dict | str:
        """
