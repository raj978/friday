				...
				<div class="text-5xl lg:text-7xl font-secondary">
					<Marquee
						...
						words={[
							...
							$i18n.t('Always at your service'),
							$i18n.t('Organize your knowledge'),
							$i18n.t('Build your second brain'),
							$i18n.t('Chat with AI models'),
							$i18n.t('Search and discover'),
							$i18n.t('Manage your workspace'),
							$i18n.t('Create and learn'),
							$i18n.t('Your personal AI'),
							$i18n.t('Ready when you are')
						]}
					/>

					<div class="mt-0.5">{$i18n.t(`Good to see you, sir`)}</div>
				</div>
