...
# Functions removed in Friday rebrand - filter functionality disabled
def get_sorted_filter_ids(request, model: dict, enabled_filter_ids: list = None):
    """Filter functionality disabled - Functions model removed"""
    return []
...
# Functions removed in Friday rebrand - filter processing disabled
async def process_filter_functions(
    request, filter_functions, filter_type, form_data, extra_params
):
    """Filter processing disabled - Functions model removed"""
    return form_data, {}
